...
const sequelize = new Sequelize("uklkasir", "root", "", {
  host: "localhost",
  dialect: "mysql",
});
...
exports.getTransaksiById = async (request, response) => {
    ...
    try {
        let transaksi = await sequelize.query(
            `SELECT transaksi.id_transaksi, transaksi.tgl_transaksi, transaksi.id_user, transaksi.id_meja, transaksi.nama_pelanggan, transaksi.status, menu.nama_menu, menu.harga
